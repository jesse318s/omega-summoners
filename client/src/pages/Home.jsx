          ...
          <div className="container-fluid">
            ...
            <div className="d-flex align-items-center">
              <ul className="navbar-nav">
                <li className="nav-item font-weight-bold">
                  <a className="mx-2 nav-link" href="#login_signup">
                    Login / Sign up
                  </a>
                </li>
              </ul>
      ...
      <main>
        ...
        <section className="mx-2" id="gameplay">
          ...
          >
            ...
            <div className="carousel-inner">
              ...
              <div className="carousel-item active">
                ...
                <div className="carousel-caption d-none d-md-block">
                  ...
                  <p>
                    Utilize your skills and stats to defeat enemies and gain
                    loot.
                  </p>
                </div>
              </div>
              ...
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block">
                  ...
                  <p>Desktop, mobile, and tablet versions. Play anywhere!</p>
                </div>
              </div>
              ...
              <div className="carousel-item">
                ...
                <div className="carousel-caption d-none d-md-block">
                  ...
                  <p>
                    Summons have a unique set of skills that can be used to
                    defeat enemies.
                  </p>
                </div>
              </div>
            ...
            <button
              ...
              data-mdb-slide="prev"
            >
              <span className="font_large" aria-hidden="true">
                {"\u276E"}
              </span>
        ...
        <section className="mx-2" id="about">
          ...
          <p className="text-light">
            Omega Summoners is a simple, online RPG meant for all platforms.
            Greek mythology takes a special place in the game. The player is a
            mortal, chosen by the gods to summon creatures from the heavens, and
        ...
        {/* footer */}
        <footer>
          <p>&copy; 2023 Jesse All Rights Reserved.</p>
        </footer>
      </main>
    </>
  );
